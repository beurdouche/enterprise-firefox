...
felt-warning-title-posture-unavailable =
    .heading = Required software can’t be managed
felt-error-warning-posture-unavailable-contact-admin = { -brand-short-name } can’t manage { $tool } on this device because the required package manager isn’t installed. Please contact your administrator.
felt-posture-remediate =
    .label = Fix now
